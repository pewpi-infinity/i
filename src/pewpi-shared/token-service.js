...
class TokenService {
  ...
  async getById(id) {
    ...
    if (this.useLocalStorage) {
      return this._getByIdLocalStorage(id);
    } else {
  ...
  async update(id, updates) {
    ...
    if (this.useLocalStorage) {
      return this._updateTokenLocalStorage(id, updates);
    } else {
  ...
  /**
   * Emit event to subscribers and window (with localStorage broadcast for cross-tab sync)
   */
  ...
  _updateTokenLocalStorage(id, updates) {
    const tokens = this._getAllLocalStorage();
